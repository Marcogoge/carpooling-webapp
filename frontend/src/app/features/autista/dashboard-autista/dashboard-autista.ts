 import { Component, OnInit } from '@angular/core';
  ...
  export class DashboardAutistaComponent implements OnInit {
    ...
    ngOnInit(){
      ...
      if(!this.utente||this.utente.tipo!=='autista'){ this.router.navigate(['/login']); return; }
    ...
    elimina(id:number){
      ...
      this.vs.eliminaViaggio(id).subscribe(()=>{ this.viaggi=this.viaggi.filter(v=>v.id_viaggio!==id); });
    }
  }
